...
#cd /Volumes/workspace/sl/sl-devops-utils/sl-local/docker
#set -x
...
if [ "$1" == "help" ]; then
  ...
  echo " bash /vagrant/sl-local/docker/vault.sh put devops-prod devops-utils resources"
  echo " bash /vagrant/sl-local/docker/vault.sh get devops-prod devops-utils"
  echo " bash /vagrant/sl-local/docker/vault.sh delete devops-prod devops-utils"
  echo " bash /vagrant/sl-local/docker/vault.sh fput tgd-dev sl-partners_pk.pem pk.pem"
  echo " bash /vagrant/sl-local/docker/vault.sh fget tgd-dev sl-partners_pk.pem"
  echo " bash /vagrant/sl-local/docker/vault.sh 2env df.json"
  echo " bash /vagrant/sl-local/docker/vault.sh 2json .env"
  echo "##################################################################################################"
  exit 0
fi
