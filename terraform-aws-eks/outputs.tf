...
output "eks_managed_node_groups_autoscaling_group_names" {
  ...
  value       = compact(flatten([for group in module.base : group.node_group_autoscaling_group_names]))
}
...
output "aws_auth_configmap_yaml" {
  ...
  value = templatefile("${path.module}/templates/aws_auth_cm.tpl",
    {
      eks_managed_role_arns                   = distinct(compact([for group in module.base : group.iam_role_arn]))
